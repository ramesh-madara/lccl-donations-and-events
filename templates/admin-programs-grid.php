...
<div class="lccl-prog__grid">
	...
	<a class="lccl-prog__card" href="<?php echo esc_url( LCCL_DE_Admin_Programs::projects_url() ); ?>">
		<span class="lccl-prog__card-kicker"><?php esc_html_e( 'Program', 'lccl-de' ); ?></span>
	...
	<a class="lccl-prog__card" href="<?php echo esc_url( LCCL_DE_Admin_Programs::spectacles_url() ); ?>">
		<span class="lccl-prog__card-kicker"><?php esc_html_e( 'Program', 'lccl-de' ); ?></span>
